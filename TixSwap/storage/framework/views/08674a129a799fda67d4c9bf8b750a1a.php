...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>" class="h-full bg-gray-50">
    <head>
        ...
        <title><?php echo e($title ?? 'TixSwap Admin'); ?></title>
    ...
    <a href="<?php echo e(route('admin.dashboard')); ?>" class="<?php echo e(request()->routeIs('admin.dashboard') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white'); ?> group flex items-center px-2 py-2 text-sm font-medium rounded-md">
    ...
    <a href="<?php echo e(route('admin.listings.index')); ?>" class="<?php echo e(request()->routeIs('admin.listings.index') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white'); ?> group flex items-center px-2 py-2 text-sm font-medium rounded-md">
     ...
     <a href="<?php echo e(route('admin.users.index')); ?>" class="<?php echo e(request()->routeIs('admin.users.index') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white'); ?> group flex items-center px-2 py-2 text-sm font-medium rounded-md">
                     ...
                     <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 h-16 flex justify-end items-center">
                        <!-- User profile section -->
                         <div class="flex items-center">
                             <span class="mr-3 font-medium"><?php echo e(Auth::user()->name); ?></span>
                             <form method="POST" action="<?php echo e(route('logout')); ?>">
                                 <?php echo csrf_field(); ?>
                                 <a href="<?php echo e(route('logout')); ?>" onclick="event.preventDefault(); this.closest('form').submit();" class="text-gray-500 hover:text-gray-700">
                                     Log Out
                                 </a>
                             </form>
                         </div>
...
</html><?php /**PATH C:\Users\senet\TixSwap\TixSwap\resources\views/components/admin-layout.blade.php ENDPATH**/ ?>