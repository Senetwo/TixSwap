            ...
            <div class="p-8 overflow-y-auto" id="ticket-to-save">
                <div class="bg-gray-50 p-6 rounded-lg border">
                    ...
                    <div class="text-center">
                        ...
                        <p class="text-sm text-gray-500">{{ \Carbon\Carbon::parse($ticket->event->date)->format('l, F j, Y') }}</p>
                        <p class="text-sm text-gray-500 mb-2">{{ $ticket->event->location }}</p>
                        {{-- ADDED SEAT DETAILS --}}
        ...
        window.addEventListener('load', function() {
            ...
            saveButton.addEventListener('click', function() {
                html2canvas(ticketElement, {
                    ...
                    link.download = 'TixSwap-Ticket-{{ $ticket->event->name }}.png';
